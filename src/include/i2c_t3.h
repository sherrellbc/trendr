...
//
typedef enum i2c_op_mode  {I2C_OP_MODE_IMM, I2C_OP_MODE_ISR, I2C_OP_MODE_DMA} i2c_op_mode;
typedef enum i2c_mode     {I2C_MASTER, I2C_SLAVE} i2c_mode;
typedef enum i2c_pullup   {I2C_PULLUP_EXT, I2C_PULLUP_INT} i2c_pullup;
typedef enum i2c_rate     {I2C_RATE_100  = 100000,
                   ...
                   I2C_RATE_3000 = 3000000} i2c_rate;
typedef enum i2c_stop     {I2C_NOSTOP, I2C_STOP} i2c_stop;
typedef enum i2c_status   {I2C_WAITING,
                   I2C_SENDING,
                   I2C_SEND_ADDR,
                   I2C_RECEIVING,
                   I2C_TIMEOUT,
                   ...
                   I2C_BUF_OVF,
                   I2C_SLAVE_TX,
                   I2C_SLAVE_RX} i2c_status;
typedef enum i2c_dma_state {I2C_DMA_OFF,
                    I2C_DMA_ADDR,
                    I2C_DMA_BULK,
                    I2C_DMA_LAST} i2c_dma_state;
    ...
    typedef enum i2c_pins {I2C_PINS_16_17,          // 16 SCL0  17 SDA0
                   I2C_PINS_18_19,          // 19 SCL0  18 SDA0
                   I2C_PINS_29_30,          // 29 SCL1  30 SDA1
                   I2C_PINS_26_31} i2c_pins;         // 26 SCL1  31 SDA1
